...
public class GoFeatureFlagProviderTest
{
    ...
    public async Task should_throw_an_error_if_endpoint_not_available()
    {
        ...
        var res = await client.GetBooleanDetailsAsync("fail_500", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.False(res.Value);
        Assert.Equal(ErrorType.General, res.ErrorType);
        Assert.Equal(Reason.Error, res.Reason);
    }
    ...
    public async Task should_have_bad_request_if_no_token()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetBooleanDetailsAsync("api_key_missing", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.False(res.Value);
        Assert.Equal(Reason.Error, res.Reason);
        Assert.Equal(ErrorType.General, res.ErrorType);
    ...
    public async Task should_have_unauthorized_if_invalid_token()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetBooleanDetailsAsync("invalid_api_key", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.False(res.Value);
        Assert.Equal(Reason.Error, res.Reason);
        Assert.Equal(ErrorType.General, res.ErrorType);
    ...
    public async Task should_throw_an_error_if_flag_does_not_exists()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetBooleanDetailsAsync("flag_not_found", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.False(res.Value);
        Assert.Equal(ErrorType.FlagNotFound, res.ErrorType);
        Assert.Equal(Reason.Error, res.Reason);
    }
    ...
    public async Task should_throw_an_error_if_we_expect_a_boolean_and_got_another_type()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetBooleanDetailsAsync("string_key", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.False(res.Value);
        Assert.Equal(ErrorType.TypeMismatch, res.ErrorType);
        Assert.Equal(Reason.Error, res.Reason);
    }
    ...
    public async Task should_resolve_a_valid_boolean_flag_with_TARGETING_MATCH_reason()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetBooleanDetailsAsync("bool_targeting_match", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.True(res.Value);
        Assert.Equal(ErrorType.None, res.ErrorType);
        Assert.Equal(Reason.TargetingMatch, res.Reason);
        Assert.Equal("True", res.Variant);
    }
    ...
    public async Task should_return_custom_reason_if_returned_by_relay_proxy()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetBooleanDetailsAsync("unknown_reason", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.True(res.Value);
        Assert.Equal(ErrorType.None, res.ErrorType);
        Assert.Equal("CUSTOM_REASON", res.Reason);
        Assert.Equal("True", res.Variant);
    }
    ...
    public async Task should_use_boolean_default_value_if_the_flag_is_disabled()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetBooleanDetailsAsync("disabled", false, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.False(res.Value);
        Assert.Equal(Reason.Disabled, res.Reason);
    }
    ...
    public async Task should_throw_an_error_if_we_expect_a_string_and_got_another_type()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetStringDetailsAsync("bool_targeting_match", "default", _defaultEvaluationCtx);
        Assert.NotNull(res);
    ...
    public async Task should_resolve_a_valid_string_flag_with_TARGETING_MATCH_reason()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetStringDetailsAsync("string_key", "defaultValue", _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal("CC0000", res.Value);
        Assert.Equal(ErrorType.None, res.ErrorType);
        Assert.Equal(Reason.TargetingMatch, res.Reason);
        Assert.Equal("True", res.Variant);
    }
    ...
    public async Task should_use_string_default_value_if_the_flag_is_disabled()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetStringDetailsAsync("disabled_string", "defaultValue", _defaultEvaluationCtx);
        Assert.NotNull(res);
    ...
    public async Task should_throw_an_error_if_we_expect_a_integer_and_got_another_type()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetIntegerDetailsAsync("string_key", 200, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(200, res.Value);
        Assert.Equal(ErrorType.TypeMismatch, res.ErrorType);
        Assert.Equal(Reason.Error, res.Reason);
    }
    ...
    public async Task should_resolve_a_valid_integer_flag_with_TARGETING_MATCH_reason()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetIntegerDetailsAsync("integer_key", 1200, _defaultEvaluationCtx);
        Assert.NotNull(res);
    ...
    public async Task should_use_integer_default_value_if_the_flag_is_disabled()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetIntegerDetailsAsync("disabled_integer", 1225, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(1225, res.Value);
        Assert.Equal(Reason.Disabled, res.Reason);
    }
    ...
    public async Task should_throw_an_error_if_we_expect_a_integer_and_double_type()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetIntegerDetailsAsync("double_key", 200, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(200, res.Value);
        Assert.Equal(ErrorType.TypeMismatch, res.ErrorType);
        Assert.Equal(Reason.Error, res.Reason);
    ...
    public async Task should_resolve_a_valid_double_flag_with_TARGETING_MATCH_reason()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetDoubleDetailsAsync("double_key", 1200.25, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(100.25, res.Value);
        Assert.Equal(ErrorType.None, res.ErrorType);
        Assert.Equal(Reason.TargetingMatch, res.Reason);
        Assert.Equal("True", res.Variant);
    }
    ...
    public async Task should_use_double_default_value_if_the_flag_is_disabled()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetDoubleDetailsAsync("disabled_double", 1225.34, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(1225.34, res.Value);
        Assert.Equal(Reason.Disabled, res.Reason);
    }
    ...
    public async Task should_resolve_a_valid_value_flag_with_TARGETING_MATCH_reason()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetObjectDetailsAsync("object_key", null, _defaultEvaluationCtx);
        Assert.NotNull(res);
        ...
        Assert.Equal(want, JsonSerializer.Serialize(res.Value));
        Assert.Equal(ErrorType.None, res.ErrorType);
        Assert.Equal(Reason.TargetingMatch, res.Reason);
        Assert.Equal("True", res.Variant);
    }
    ...
    public async Task should_wrap_into_value_if_wrong_type()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetObjectDetailsAsync("string_key", null, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(new Value("CC0000").AsString, res.Value.AsString);
        Assert.Equal(ErrorType.None, res.ErrorType);
        Assert.Equal(Reason.TargetingMatch, res.Reason);
        Assert.Equal("True", res.Variant);
    }
    ...
    public async Task should_use_object_default_value_if_the_flag_is_disabled()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetObjectDetailsAsync("disabled_object", new Value("default"), _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(new Value("default").AsString, res.Value.AsString);
        Assert.Equal(Reason.Disabled, res.Reason);
    }
    ...
    public async Task should_throw_an_error_if_no_targeting_key()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetStringDetailsAsync("list_key", "empty", EvaluationContext.Empty);
        Assert.NotNull(res);
        Assert.Equal("empty", res.Value);
        Assert.Equal(ErrorType.InvalidContext, res.ErrorType);
        Assert.Equal(Reason.Error, res.Reason);
    }
    ...
    public async Task should_resolve_a_valid_value_flag_with_a_list()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetObjectDetailsAsync("list_key", null, _defaultEvaluationCtx);
        Assert.NotNull(res);
    ...
    public async Task should_use_object_default_value_if_flag_not_found()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetObjectDetailsAsync("does_not_exists", new Value("default"), _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(new Value("default").AsString, res.Value.AsString);
        Assert.Equal(Reason.Error, res.Reason);
        Assert.Equal(ErrorType.FlagNotFound, res.ErrorType);
        Assert.Equal("flag does_not_exists was not found in your configuration", res.ErrorMessage);
    }
    ...
    public async Task should_resolve_a_flag_with_metadata()
    {
        ...
        await Api.Instance.SetProviderAsync(g);
        var client = Api.Instance.GetClient("test-client");
        var res = await client.GetIntegerDetailsAsync("integer_with_metadata", 1200, _defaultEvaluationCtx);
        Assert.NotNull(res);
        Assert.Equal(100, res.Value);
        Assert.Equal(ErrorType.None, res.ErrorType);
        Assert.Equal(Reason.TargetingMatch, res.Reason);
        Assert.Equal("True", res.Variant);
        Assert.NotNull(res.FlagMetadata);
        Assert.Equal("key1", res.FlagMetadata.GetString("key1"));
        Assert.Equal(1, res.FlagMetadata.GetInt("key2"));
        Assert.Equal(1.345, res.FlagMetadata.GetDouble("key3"));
        Assert.True(res.FlagMetadata.GetBool("key4"));
    }
}
