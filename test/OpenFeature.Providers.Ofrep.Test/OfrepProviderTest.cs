...
public class OfrepProviderTest : IDisposable
{
    ...
    public async Task ResolveBooleanValueAsync_ShouldReturnCorrectValue_WhenClientReturnsValidResponse()
    {
        ...
        this._mockClient
            .EvaluateBooleanFlag(flagKey, defaultValue, context, Arg.Any<CancellationToken>())
    ...
    public async Task ResolveStringValueAsync_ShouldReturnCorrectValue_WhenClientReturnsValidResponse()
    {
        ...
        this._mockClient
            .EvaluateStringFlag(flagKey, defaultValue, context, Arg.Any<CancellationToken>())
            .Returns(expectedResponse);
    ...
    public async Task ResolveIntegerValueAsync_ShouldReturnCorrectValue_WhenClientReturnsValidResponse()
    {
        ...
        this._mockClient
            .EvaluateIntegerFlag(flagKey, defaultValue, context, Arg.Any<CancellationToken>())
            .Returns(expectedResponse);
    ...
    public async Task ResolveDoubleValueAsync_ShouldReturnCorrectValue_WhenClientReturnsValidResponse()
    {
        ...
        this._mockClient
            .EvaluateDoubleFlag(flagKey, defaultValue, context, Arg.Any<CancellationToken>())
            .Returns(expectedResponse);
    ...
    public async Task ResolveStructureValueAsync_ShouldReturnCorrectValue_WhenClientReturnsValidResponse()
    {
        ...
        this._mockClient
            .EvaluateStructureFlag(flagKey, null, context, Arg.Any<CancellationToken>())
            .Returns(expectedResponse);
    ...
    public async Task ErrorMapping_ShouldMapCorrectly(string errorCode, ErrorType expectedErrorType)
    {
        ...
        this._mockClient
            .EvaluateStringFlag(flagKey, defaultValue, null, Arg.Any<CancellationToken>())
            .Returns(errorResponse);
    ...
    public async Task ResolveBooleanValueAsync_ShouldUseCorrectParameters_WhenCallingClient()
    {
        ...
        this._mockClient
            .EvaluateBooleanFlag(flagKey, defaultValue, context, cancellationToken)
            .Returns(expectedResponse);
    ...
    public async Task ResolveStringValueAsync_ShouldUseCorrectParameters_WhenCallingClient()
    {
        ...
        this._mockClient
            .EvaluateStringFlag(flagKey, defaultValue, context, cancellationToken)
            .Returns(expectedResponse);
    ...
    public async Task ResolveIntegerValueAsync_ShouldUseCorrectParameters_WhenCallingClient()
    {
        ...
        this._mockClient
            .EvaluateIntegerFlag(flagKey, defaultValue, context, cancellationToken)
            .Returns(expectedResponse);
    ...
    public async Task ResolveDoubleValueAsync_ShouldUseCorrectParameters_WhenCallingClient()
    {
        ...
        this._mockClient
            .EvaluateDoubleFlag(flagKey, defaultValue, context, cancellationToken)
            .Returns(expectedResponse);
    ...
    public async Task ResolveStructureValueAsync_ShouldUseCorrectParameters_WhenCallingClient()
    {
        ...
        this._mockClient
            .EvaluateStructureFlag(flagKey, null, context, cancellationToken)
            .Returns(expectedResponse);
        ...
        // Assert
        await this._mockClient.Received(1).EvaluateStructureFlag(flagKey, null, context, cancellationToken);
    }
    ...
    public async Task ResolveBooleanValueAsync_ShouldHandleNullContext()
    {
        ...
        this._mockClient
            .EvaluateBooleanFlag(flagKey, defaultValue, null, Arg.Any<CancellationToken>())
            .Returns(expectedResponse);
    ...
    public async Task ResolveStructureValueAsync_ShouldHandleNullContext()
    {
        ...
        this._mockClient
            .EvaluateStructureFlag(flagKey, null, null, Arg.Any<CancellationToken>())
            .Returns(expectedResponse);
